...
if (isHoliday === 'true'){
  console.log('its the holidays')
}
  else if ((age <=6 || (age >= 65 && age <= 116)) && isHoliday === 'false') {
    console.log('Its not the holidays');  
    age = +prompt('Enter your age');
    console.log('You are eligible for a discount.');
  }
   else if (age > 116 && isHoliday === 'false') {
    console.log('Its not the holidays');  
    age = +prompt('Enter your age');	
    console.log('You would be older than the oldest person on the planet, try again.')
  } 
  
  else if (age > 116 && isHoliday === 'true') {
    console.log('Its not the holidays');  
    age = +prompt('Enter your age');
    console.log('You would be older than the oldest person on the planet, try again. + its the holidays.')
  } 
  else if ((age > 6 && age < 65) && isHoliday === 'false'){
    console.log('Its not the holidays');  
    age = +prompt('Enter your age');
